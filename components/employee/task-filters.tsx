...
import { Search, Filter, AlertCircle, User } from "lucide-react"; // 👈 Added User icon
import { useState, useEffect } from "react";
import { useDebounce } from "use-debounce";

// 👈 Added employees prop to receive department-specific staff
export function TaskFilters({
  ...
  }, [debouncedQuery, status, priority, date, router]);
